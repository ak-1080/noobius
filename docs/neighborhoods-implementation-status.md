...
| --- | --- |
| Unit and SQLite rules | All 122 tests passed in the default suite, covering gameplay, providers, saves, neighborhoods, projects, social/market rules, holder authorization, race/replay protections and migration reconciliation. |
