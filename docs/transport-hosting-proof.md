...
The isolated reproduction passed raw upgrade, foreign-Origin rejection and five unique shared-room receipts on port 3004. Cleanup Site version 39 deployed at 08:54:46 UTC from `5f92ea8d837c44f78ef1a74880391160440d9838`; the app build excludes the probe and namespace. Gameplay, saves, D1 schema and hosted environment revision remain unchanged. TypeScript and the production build passed. No real multiplayer transport or external host was enabled.
